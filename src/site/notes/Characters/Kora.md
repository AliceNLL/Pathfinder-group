...
### Level 1
#### Heritage:
[[Character building stuff/Character Building/Heritages/Jinxed Tengu\|Jinxed Tengu]]
#### Ancestry Feat:
[[Character building stuff/Character Building/Feats/Squawk!\|Squawk!]]
#### Class Feat:
[[Character building stuff/Character Building/Feats/Dual-Weapon Reload\|Dual-Weapon Reload]]
#### Skill:
Intimidation
#### Extra:
[[Character building stuff/Character Building/Class Features/Gunslinger's Way\|Gunslinger's Way]]

Way of the Pistolero Skill
```pf2e-stats
##### [[Ten Paces|Ten Paces]] `[one-action]`
```
[[Character building stuff/Character Building/Ancestry Features/Low-Light Vision\|Low-Light Vision]]

[[Character building stuff/Character Building/Ancestry Features/Sharp Beak\|Sharp Beak]]

```pf2e-stats
##### [[Raconteur's Reload|Raconteur's Reload]] `[one-action]`
```
[[Character building stuff/Character Building/Class Features/Singular Expertise\|Singular Expertise]]
...
```
#### Skill Feat:
[[Character building stuff/Character Building/Feats/Dubious Knowledge\|Dubious Knowledge]]
### Level 3
#### General Feat:
[[Character building stuff/Character Building/Feats/Armored Stealth\|Armored Stealth]]
#### Extra:
[[Character building stuff/Character Building/Class Features/Stubborn\|Stubborn]]
### Level 4
#### Class Feat:
```pf2e-stats
...
```
#### Skill Feat:
[[Character building stuff/Character Building/Feats/Terrain Expertise\|Terrain Expertise]]
#### Extra:
Plains
### Level 5
#### Ancestry Feat:
...
```
#### Extra:
[[Character building stuff/Character Building/Class Features/Gunslinger Weapon Mastery\|Gunslinger Weapon Mastery]]
### Level 6
#### Class Feat:
```pf2e-stats
